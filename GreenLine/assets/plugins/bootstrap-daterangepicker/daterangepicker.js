!function ($) {
    var DateRangePicker = function (element, options, cb) {
        ...
        constructor: DateRangePicker, setOptions: function (options, callback) {
            ...
            monthHtml += "</select>"; var currentYear = selected.year(); var maxYear = (maxDate && maxDate.year()) || (currentYear + 5); var minYear = (minDate && minDate.year()) || (currentYear - 2); var yearHtml = '<select class="yearselect">'; for (var y = minYear; y <= maxYear; y++) { yearHtml += '<option value="' + y + '"' + (y === currentYear ? ' selected="selected"' : '') + '>' + y + '</option>'; }
